...
export default function Add() {
  ...
  async function handleSubmit() {
    ...
    if (!location) {
      Alert.alert('Erro', 'A localização é obrigatória. Clica em "Obter localização".')
      return
    }
    ...
    try {
      ...
      Alert.alert('Sucesso!', 'Observação submetida. Ficará pendente até ser validada.', [
    ...
    <ScrollView style={[styles.container, { paddingTop: insets.top }]} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.section}>
        ...
        <View style={styles.photoButtons}>
          ...
          <TouchableOpacity style={[styles.photoBtn, styles.photoBtnOutline]} onPress={pickFromGallery}>
            ...
            <Text style={[styles.photoBtnText, { color: '#1a3c2e' }]}>Galeria</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.hint}>
          <Ionicons name="information-circle-outline" size={13} color="#999" /> Um técnico irá confirmar a classificação
        </Text>
      </View>
          ...
          {loadingLocation ? (
            ...
            <>
              ...
              <Text style={styles.locationBtnText}>
                {location ? locationName || `${location.latitude.toFixed(4)}, ${location.longitude.toFixed(4)}` : 'Obter localização atual'}
              </Text>
              {location && <Ionicons name="pencil-outline" size={16} color="#999" />}
            </>
          )}
        </TouchableOpacity>
      </View>
      ...
      <Text style={styles.submitHint}>A submissão fica em estado pendente até validação</Text>
